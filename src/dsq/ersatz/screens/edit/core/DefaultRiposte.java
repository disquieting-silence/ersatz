...
public class DefaultRiposte implements Riposte {
    ...
    public DefaultRiposte(final Activity activity, final SQLiteDatabase db, final RiposteId id) {
    ...
    private EditUi setupUi(final Activity activity) {
